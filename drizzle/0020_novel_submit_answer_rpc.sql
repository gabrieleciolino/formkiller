...
REVOKE ALL ON FUNCTION "public"."submit_public_form_answer"(uuid, uuid, uuid, text, text, timestamp with time zone, text) FROM PUBLIC;
--> statement-breakpoint
GRANT EXECUTE ON FUNCTION "public"."submit_public_form_answer"(uuid, uuid, uuid, text, text, timestamp with time zone, text) TO "service_role";
