              ...
              {content.features.map((f, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="font-roboto text-lg font-black">
                      {f.title}
                    </h3>
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
                Trasforma il classico form in un&apos;esperienza guidata,
                interattiva e molto più efficace per raccogliere lead
                qualificati.
              </p>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <div className="rounded-2xl border border-border bg-card p-8">
                <div className="mb-6">
                  ...
                  <div className="mt-2 flex items-baseline gap-1">
                    <span className="font-roboto text-4xl font-black">
                      29,99€
                    </span>
                    <span className="text-sm text-muted-foreground">/mese</span>
                  </div>
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                    Per chi vuole sostituire il classico form con
                    un&apos;esperienza più moderna, semplice e brandizzata.
                  </p>
                </div>
              ...
              <div className="relative rounded-2xl border-2 border-primary bg-card p-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                    Per chi vuole un&apos;esperienza più immersiva, più
                    personalizzata e più efficace nella raccolta dei lead.
                  </p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2.5">
                    {[
                      "Risposte audio da parte degli utenti (120 minuti inclusi)",
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground">
                        Dai al tuo funnel una voce unica e riconoscibile,
                        perfettamente allineata al tuo brand.
                      </p>
                    </div>
                    <div className="shrink-0 text-right">
                      <span className="font-roboto text-lg font-black">
                        +19,99€
                      </span>
                ...
                <div className="rounded-2xl border border-border bg-card p-6">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground">
                        Aggiungi tempo extra al tuo piano PRO quando hai più
                        traffico o campagne attive.
                      </p>
                    </div>
                    <div className="shrink-0 text-right">
                      <span className="font-roboto text-lg font-black">
